...
export default function Section() {
    return (
        <section className='max-w-[1560px] m-auto'>
            <div className={`image relative z-0`} >
                <div className='w-[1520px] m-auto bg-[#000000b1] absolute z-10 h-[600px]'>
                    <div className='text-[white]'>
                        <div className='max-w-[1300px] m-auto flex justify-between items-center pt-[100px]'>
            ...
            <div className='max-w-[1300px] m-auto flex justify-center items-center py-[50px]'>
